...
export class FundEditComponent implements OnInit {
  ...
  constructor(private apiProviderService: ApiProviderService
    ...
    this.url = {
      create: this.apiProviderService.fund.create,
      read: this.apiProviderService.fund.read,
      update: this.apiProviderService.fund.update,
      delete: this.apiProviderService.fund.delete,
      category: {
        create: this.apiProviderService.fund.category.create,
        read: this.apiProviderService.fund.category.read,
        update: this.apiProviderService.fund.category.update,
        delete: this.apiProviderService.fund.category.delete
      },
      gallery: {
        create: this.apiProviderService.fund.gallery.create,
        read: this.apiProviderService.fund.gallery.read,
        update: this.apiProviderService.fund.gallery.update,
        delete: this.apiProviderService.fund.gallery.delete
      }
    }
  ...
  ngOnInit(): void {
    ...
    this.permission = this.permissionService.readPermission('fundPage');
    this.permissionList = this.permissionService.readLocalStorage('fundPage');
  ...
  readCategory(param: string) {
    ...
    if (this.editModel.language != '') {
      this.serviceProviderService.post('fund/category/read', { language: param, permission: this.permission }).subscribe(data => {
        let model: any = {};
        model = data;
        this.listCategory = [];
  ...
  galleryRead() {
    this.serviceProviderService.post('m/fund/gallery/read', { code: this.editModel.code }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  back() {
    this.router.navigate(['fund'], { skipLocationChange: true });
  }
}
