...
export class NewsEditComponent implements OnInit {
  ...
  readComment() {
      this.serviceProviderService.post('news/comment/read', { code: this.code }).subscribe(data => {
        let model: any = {};
        model = data;
  ...
  manageComment(param) {
    ...
    this.spinner.show()
    this.serviceProviderService.post('news/comment/update', param).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  verifyComment(param) {
    this.spinner.show()
    this.serviceProviderService.post('news/comment/verify', param).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  exportAsXLSX(): void {
    this.serviceProviderService.post('news/comment/read', { skip: 0, limit: 999999 }).subscribe(data => {
      let model: any = {};
      let result: any = [];
      model = data;
