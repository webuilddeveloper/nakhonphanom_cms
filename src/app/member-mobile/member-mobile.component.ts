...
@Component({
  selector: 'app-member-mobile',
  templateUrl: './member-mobile.component.html',
  styleUrls: ['./member-mobile.component.css']
})
export class MemberMobileComponent implements OnInit {
  ...
  read() {
    ...
    this.serviceProviderService.post('m/register/read', this.criteriaModel).subscribe(data => {
      setTimeout(() => {
        let model: any = {};
        model = data;
