...
@Component({
  selector: 'app-reporter-category-criteria',
  templateUrl: './reporter-category-criteria.component.html',
  styleUrls: ['./reporter-category-criteria.component.css']
})
export class ReporterCategoryCriteriaComponent implements OnInit {
