...
@Component({
  selector: 'app-poll-criteria',
  templateUrl: './poll-criteria.component.html',
  styleUrls: ['./poll-criteria.component.css']
})
export class PollCriteriaComponent implements OnInit {
  ...
  readSequence() {
    ...
    this.serviceProviderService.post('groupby/read', { permission: this.permission,title: 'poll' }).subscribe(data => {
      let model: any = {};
      model = data;
