...
@Component({
  selector: 'app-privilege-category-criteria',
  templateUrl: './privilege-category-criteria.component.html',
  styleUrls: ['./privilege-category-criteria.component.css']
})
export class PrivilegeCategoryCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('privilegeCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('privilegeCategoryPage'));
