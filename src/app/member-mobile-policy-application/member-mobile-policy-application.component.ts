...
@Component({
  selector: 'app-member-mobile-policy-application',
  templateUrl: './member-mobile-policy-application.component.html',
  styleUrls: ['./member-mobile-policy-application.component.css']
})
export class MemberMobilePolicyApplicationComponent implements OnInit {
  ...
  read() {
    ...
    this.serviceProviderService.post('policy/register/read', this.criteriaModel).subscribe(data => {
      setTimeout(() => {
        let model: any = {};
        model = data;
