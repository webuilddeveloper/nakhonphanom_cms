...
@Component({
  selector: 'app-contact-category-criteria',
  templateUrl: './contact-category-criteria.component.html',
  styleUrls: ['./contact-category-criteria.component.css']
})
export class ContactCategoryCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('contactCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('contactCategoryPage'));
