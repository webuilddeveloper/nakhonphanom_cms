...
export class SuggestionEditComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('suggestionPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('suggestionPage'));
      ...
      this.permissionList = JSON.parse(localStorage.getItem('suggestionPage'));
    }
    ...
    this.activetedRoute.queryParams.subscribe(params => {
      ...
      if (this.code != '') {
        this.title = 'แก้ไขข้อมูลข้อเสนอแนะ';
        this.read();
      }
  ...
  create() {
    ...
    this.serviceProviderService.post('suggestion/create', this.editModel).subscribe(data => {
      ...
      if (this.editModel.gallery.length > 0) {
        this.editModel.gallery.forEach(element => {
          ...
          this.serviceProviderService.post('suggestion/gallery/create', element).subscribe(data => { }, err => { });
        });
      }
  ...
  read() {
    this.spinner.show();
    this.serviceProviderService.post('suggestion/read', { code: this.code, permission: this.permission }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  update() {
    ...
    this.spinner.show();
    this.serviceProviderService.post('suggestion/update', this.editModel).subscribe(data => {
      this.serviceProviderService.post('suggestion/gallery/delete', this.editModel).subscribe(data => {
        if (this.editModel.gallery.length > 0) {
          this.editModel.gallery.forEach(element => {
  ...
  readCategory(param) {
    ...
    if (this.editModel.language != '') {
      this.serviceProviderService.post('suggestion/category/read', { language: param, permission: this.permission }).subscribe(data => {
        let model: any = {};
        model = data;
  ...
  galleryRead() {
    this.serviceProviderService.post('m/suggestion/gallery/read', { code: this.editModel.code }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  back() {
    this.router.navigate(['suggestion'], { skipLocationChange: true });
  }
