...
@Component({
  selector: 'app-notification-category-criteria',
  templateUrl: './notification-category-criteria.component.html',
  styleUrls: ['./notification-category-criteria.component.css']
})
export class NotificationCategoryCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('notificationCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('notificationCategoryPage'));
