...
@Component({
  selector: 'app-poi-category-criteria',
  templateUrl: './poi-category-criteria.component.html',
  styleUrls: ['./poi-category-criteria.component.css']
})
export class PoiCategoryCriteriaComponent implements OnInit {
