...
@Component({
  selector: 'app-cooperative-form-category',
  templateUrl: './cooperative-form-category.component.html',
  styleUrls: ['./cooperative-form-category.component.css']
})
export class CooperativeFormCategoryComponent implements OnInit {
  model: any = [];
  listModel: string = '';
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('cooperativeFormCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('cooperativeFormCategoryPage'));
