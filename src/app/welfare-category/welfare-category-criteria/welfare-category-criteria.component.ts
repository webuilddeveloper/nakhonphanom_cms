...
@Component({
  selector: 'app-welfare-category-criteria',
  templateUrl: './welfare-category-criteria.component.html',
  styleUrls: ['./welfare-category-criteria.component.css']
})
export class WelfareCategoryCriteriaComponent implements OnInit {
