...
@Component({
  selector: 'app-reporter-category',
  templateUrl: './reporter-category.component.html',
  styleUrls: ['./reporter-category.component.css']
})
export class ReporterCategoryComponent implements OnInit {
  model: any = [];
  listModel: string = '';
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('reporterCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('reporterCategoryPage'));
