...
@Component({
  selector: 'app-notification-criteria',
  templateUrl: './notification-criteria.component.html',
  styleUrls: ['./notification-criteria.component.css']
})
export class NotificationCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('notificationPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('notificationPage'));
  ...
  readSequence() {
    ...
    this.serviceProviderService.post('groupby/read', { permission: this.permission,title: 'notification' }).subscribe(data => {
      let model: any = {};
      model = data;
      debugger
  ...
  readCategory() {
    ...
    this.serviceProviderService.post('notification/category/read', this.criteriaModel).subscribe(data => {
      let model: any = {};
      model = data;
