...
@Component({
  selector: 'app-training-category-criteria',
  templateUrl: './training-category-criteria.component.html',
  styleUrls: ['./training-category-criteria.component.css']
})
export class TrainingCategoryCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('trainingCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('trainingCategoryPage'));
