...
editModel: any = { fileUrl: '' , file: [],sequence: 10, language: 'th' };
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('knowledgePage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('knowledgePage'));
      ...
      this.permissionList = JSON.parse(localStorage.getItem('knowledgePage'));
    }
  ...
  create() {
    ...
    // <----- Organization
    this.serviceProviderService.post('knowledge/create', this.editModel).subscribe(data => {
  ...
  read() {
    ...
    this.serviceProviderService.post('knowledge/read', { code: this.code, permission: this.permission }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  update() {
    ...
    this.spinner.show();
    this.serviceProviderService.post('knowledge/update', this.editModel).subscribe(data => {
  ...
  readCategory(param) {
    ...
    if (this.editModel.language != '') {
      this.serviceProviderService.post('m/knowledge/category/read', { language: param, permission: this.permission }).subscribe(data => {
        let model: any = {};
        model = data;
        this.listCategory = [];
  ...
  back() {
    this.router.navigate(['knowledge'], { skipLocationChange: true });
  }
