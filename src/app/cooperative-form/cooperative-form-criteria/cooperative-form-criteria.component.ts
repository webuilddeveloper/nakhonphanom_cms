...
@Component({
  selector: 'app-cooperative-form-criteria',
  templateUrl: './cooperative-form-criteria.component.html',
  styleUrls: ['./cooperative-form-criteria.component.css']
})
export class CooperativeFormCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('cooperative-formPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('cooperative-formPage'));
  ...
  readSequence() {
    ...
    this.serviceProviderService.post('groupby/read', { permission: this.permission,title: 'cooperative-form' }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  readCategory() {
    ...
    this.serviceProviderService.post('cooperativeForm/category/read', this.criteriaModel).subscribe(data => {
      let model: any = {};
      model = data;
