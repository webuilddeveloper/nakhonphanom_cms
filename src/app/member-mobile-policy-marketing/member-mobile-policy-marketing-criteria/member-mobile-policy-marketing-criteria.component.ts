...
@Component({
  selector: 'app-member-mobile-policy-marketing-criteria',
  templateUrl: './member-mobile-policy-marketing-criteria.component.html',
  styleUrls: ['./member-mobile-policy-marketing-criteria.component.css']
})
export class MemberMobilePolicyMarketingCriteriaComponent implements OnInit {
