...
@Component({
  selector: 'app-organization2-lv1-edit',
  templateUrl: './organization2-lv1-edit.component.html',
  styleUrls: ['./organization2-lv1-edit.component.css']
})
export class Organization2Lv1EditComponent implements OnInit {

  title: string = 'เพิ่มข้อมูลเขต';
  code: string = '';
  editModel: any = {};
  lv0Category: any = [];
