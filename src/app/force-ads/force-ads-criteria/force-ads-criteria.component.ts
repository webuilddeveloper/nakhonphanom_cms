...
@Component({
  selector: 'app-force-ads-criteria',
  templateUrl: './force-ads-criteria.component.html',
  styleUrls: ['./force-ads-criteria.component.css']
})
export class ForceAdsCriteriaComponent implements OnInit {
  ...
  readSequence() {
    ...
    this.serviceProviderService.post('groupby/read', { permission: this.permission,title: 'forceAds' }).subscribe(data => {
      let model: any = {};
      model = data;
