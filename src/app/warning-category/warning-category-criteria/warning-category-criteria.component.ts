...
@Component({
  selector: 'app-warning-category-criteria',
  templateUrl: './warning-category-criteria.component.html',
  styleUrls: ['./warning-category-criteria.component.css']
})
export class WarningCategoryCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('warningCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('warningCategoryPage'));
