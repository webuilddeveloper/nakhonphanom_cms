...
@Component({
  selector: 'app-poll-category-criteria',
  templateUrl: './poll-category-criteria.component.html',
  styleUrls: ['./poll-category-criteria.component.css']
})
export class PollCategoryCriteriaComponent implements OnInit {
