...
@Component({
  selector: 'app-member-mobile-policy-marketing',
  templateUrl: './member-mobile-policy-marketing.component.html',
  styleUrls: ['./member-mobile-policy-marketing.component.css']
})
export class MemberMobilePolicyMarketingComponent implements OnInit {
