...
@Component({
  selector: 'app-suggestion-category',
  templateUrl: './suggestion-category.component.html',
  styleUrls: ['./suggestion-category.component.css']
})
export class SuggestionCategoryComponent implements OnInit {
  model: any = [];
  listModel: string = '';
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('suggestionCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('suggestionCategoryPage'));
