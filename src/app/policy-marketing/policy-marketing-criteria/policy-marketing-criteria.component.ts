...
@Component({
  selector: 'app-policy-marketing-criteria',
  templateUrl: './policy-marketing-criteria.component.html',
  styleUrls: ['./policy-marketing-criteria.component.css']
})
export class PolicyMarketingCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('policyMarketingPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('policyMarketingPage'));
  ...
  reset() {
    ...
    this.criteriaModel.category = 'marketing';
