...
@Component({
  selector: 'app-welfare-category',
  templateUrl: './welfare-category.component.html',
  styleUrls: ['./welfare-category.component.css']
})
export class WelfareCategoryComponent implements OnInit {
  model: any = [];
  listModel: string = '';
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('welfareCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('welfareCategoryPage'));
