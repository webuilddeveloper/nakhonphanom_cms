...
@Component({
  selector: 'app-cooperative-form-category-criteria',
  templateUrl: './cooperative-form-category-criteria.component.html',
  styleUrls: ['./cooperative-form-category-criteria.component.css']
})
export class CooperativeFormCategoryCriteriaComponent implements OnInit {
