...
@Component({
  selector: 'app-knowledge-category-criteria',
  templateUrl: './knowledge-category-criteria.component.html',
  styleUrls: ['./knowledge-category-criteria.component.css']
})
export class KnowledgeCategoryCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('knowledgeCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('knowledgeCategoryPage'));
