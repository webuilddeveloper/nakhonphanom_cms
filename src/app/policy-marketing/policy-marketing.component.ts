...
@Component({
  selector: 'app-policy-marketing',
  templateUrl: './policy-marketing.component.html',
  styleUrls: ['./policy-marketing.component.css']
})
export class PolicyMarketingComponent implements OnInit {
  model: any = [];
  listModel: string = '';
