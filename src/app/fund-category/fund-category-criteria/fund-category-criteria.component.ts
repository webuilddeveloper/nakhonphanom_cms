...
@Component({
  selector: 'app-fund-category-criteria',
  templateUrl: './fund-category-criteria.component.html',
  styleUrls: ['./fund-category-criteria.component.css']
})
export class FundCategoryCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('fundCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('fundCategoryPage'));
