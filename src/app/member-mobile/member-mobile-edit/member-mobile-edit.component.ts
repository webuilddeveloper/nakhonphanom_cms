...
export class MemberMobileEditComponent implements OnInit {
  ...
  create() {
    ...
    this.serviceProviderService.post('m/register/create', this.editModel).subscribe(data => {
  ...
  read() {
    this.serviceProviderService.post('m/register/read', { code: this.code }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  update() {
    ...
    this.serviceProviderService.post('m/register/update', this.editModel).subscribe(data => {
  ...
  // readCategory() {
  //   this.serviceProviderService.post('m/register/category/read', {}).subscribe(data => {
  //     let model: any = {};
  //     model = data;
  //     this.listCategory = [];
  //     model.objectData.forEach(element => {
