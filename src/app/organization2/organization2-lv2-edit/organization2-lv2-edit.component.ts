...
@Component({
  selector: 'app-organization2-lv2-edit',
  templateUrl: './organization2-lv2-edit.component.html',
  styleUrls: ['./organization2-lv2-edit.component.css']
})
export class Organization2Lv2EditComponent implements OnInit {

  title: string = 'เพิ่มข้อมูลจังหวัด';
  code: string = '';
  editModel: any = {};
  lv0Category: any = [];
  lv1Category: any = [];
