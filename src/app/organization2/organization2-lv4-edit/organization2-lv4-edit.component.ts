...
@Component({
  selector: 'app-organization2-lv4-edit',
  templateUrl: './organization2-lv4-edit.component.html',
  styleUrls: ['./organization2-lv4-edit.component.css']
})
export class Organization2Lv4EditComponent implements OnInit {
  title: string = 'เพิ่มข้อมูลตำบล/แขวง';
  code: string = '';
  editModel: any = {};
  lv0Category: any = [];
  lv1Category: any = [];
  ...
  ngOnInit(): void {
    ...
    this.activetedRoute.queryParams.subscribe(params => {
      ...
      if (this.code != '') {
        this.title = 'แก้ไขข้อมูลตำบล/แขวง';
        this.read();
      }
